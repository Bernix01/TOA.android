...
import toa.toa.R;
import toa.toa.adapters.CollectionPagerCyclingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.getUserById(__n_id, new SirUserRetrieverClass() {
            ...
            public void goIt(MrUser user) {
                __user = user;
                ViewPager pager = (ViewPager) findViewById(R.id.pagerCycling);
                pager.setAdapter(new CollectionPagerCyclingAdapter(getSupportFragmentManager(), currentUser.get_id()));
                PagerSlidingTabStrip tabs = (PagerSlidingTabStrip) findViewById(R.id.tabsCycling);
