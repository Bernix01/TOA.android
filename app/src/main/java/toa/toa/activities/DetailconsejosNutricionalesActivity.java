...
import toa.toa.R;
import toa.toa.fragments.DetailFragment;
 ...
 * de las metas.
 */
public class DetailconsejosNutricionalesActivity extends AppCompatActivity {
    /**
    ...
    public static Intent getLaunchIntent(Context context, String idMeta) {
        Intent intent = new Intent(context, DetailconsejosNutricionalesActivity.class);
