 ...
 */
public class CollectionPagerFootbolAdapter extends FragmentStatePagerAdapter implements PagerSlidingTabStrip.IconTabProvider {
    ...
    public CollectionPagerFootbolAdapter(FragmentManager fm, int id) {
        super(fm);
        Log.e("id", id + "");
        this.id = id;
    }
