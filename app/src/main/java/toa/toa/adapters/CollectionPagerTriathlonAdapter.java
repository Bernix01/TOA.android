 ...
 */
public class CollectionPagerTriathlonAdapter extends FragmentStatePagerAdapter implements PagerSlidingTabStrip.IconTabProvider {
    ...
    public CollectionPagerTriathlonAdapter(FragmentManager fm, int id) {
        super(fm);
        Log.e("id", id + "");
        this.id = id;
    }
