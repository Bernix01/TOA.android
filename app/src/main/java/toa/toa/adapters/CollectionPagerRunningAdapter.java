 ...
 */
public class CollectionPagerRunningAdapter extends FragmentStatePagerAdapter implements PagerSlidingTabStrip.IconTabProvider {
    ...
    public CollectionPagerRunningAdapter(FragmentManager fm, int id) {
        super(fm);
        Log.e("id", id + "");
        this.id = id;
    }
