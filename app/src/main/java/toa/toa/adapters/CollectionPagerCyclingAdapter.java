 ...
 */
public class CollectionPagerCyclingAdapter extends FragmentStatePagerAdapter implements PagerSlidingTabStrip.IconTabProvider {
    ...
    public CollectionPagerCyclingAdapter(FragmentManager fm, int id) {
        super(fm);
        Log.e("id", id + "");
        this.id = id;
    }
